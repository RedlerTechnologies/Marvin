/**
  ******************************************************************************
  * @file    TIM_PWM_Input/stm32f0xx_it.c 
...
void DMA1_Channel2_3_IRQHandler(void)
{
  ...
  if((DMA1->ISR & DMA_ISR_TCIF2) == DMA_ISR_TCIF2)   //Channel2 Transfer complete
  {
  ...
  else if((DMA1->ISR & DMA_ISR_TCIF3) == DMA_ISR_TCIF3) //Channel3 Transfer complete
  {
    DMA1->IFCR |= DMA_IFCR_CTCIF3;/* Clear TC flag */

    DMA1_Channel3->CCR &=~ DMA_CCR_EN;
    DMA1_Channel3->CNDTR = PROTOCOL_PACKET_SIZE;/* Data size */
    DMA1_Channel3->CCR |= DMA_CCR_EN;
